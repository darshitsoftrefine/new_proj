...
class CustomWidgets{
          ...
          GestureDetector(
            ...
            child: SizedBox(
              ...
              child: Card(
                ...
                color: Colors.white,
                child: Padding(
                  padding: const EdgeInsets.only(top: 5.0, left: 15, right: 5, bottom: 0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
            ...
            child: Card(
                ...
                child: Stack(
                  children: [
                    ...
                    const Padding(
                      padding: EdgeInsets.only(right: 40.0, top: 45),
                      child: Align(
                        alignment: Alignment.bottomRight,
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Column barChartCard(String? text){
    return Column(
      children: [
        SizedBox(
          height: 138,
